...
def lambda_handler(event, context):
    ...
    skills, emails, unis, firstnames, lastnames, user_index = get_db(rds_host, name, password, db_name, 'xz3014@columbia.edu', '')
    ...
    print(info)
    user_1_email = 'edwardzhou0630@gmail.com'
    user_1_class = 'COMS E6998'
